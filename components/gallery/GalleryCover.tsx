            ...
            <div className="absolute inset-0 z-10 p-6 md:p-12 flex flex-col justify-between h-full w-full overflow-y-auto overflow-x-hidden animate-in fade-in zoom-in duration-1000 slide-in-from-bottom-4">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 md:gap-0 mt-auto w-full">
                    ...
                    <div className="md:self-end">
                        <button
                            onClick={onEnter}
                            className="group relative flex items-center gap-3 px-8 py-3 bg-white/5 hover:bg-white/10 border border-white/20 backdrop-blur-md rounded transition-all duration-500 transform hover:scale-105 hover:border-white/40 ring-1 ring-white/10"
                        >
