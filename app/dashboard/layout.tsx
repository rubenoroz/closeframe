...
import { LayoutGrid, LogOut, CalendarDays, ChevronDown, User, Users, CreditCard, Menu, X, Sun, Moon, Shield, Wallet, Network } from "lucide-react";
...
export default function DashboardLayout({
    ...
    const { canUse, role: userRole } = useFeatures();
