            ...
            <main className="space-y-14">
                ...
                <section>
                    ...
                    <div className="p-8 rounded-3xl border border-neutral-800 bg-neutral-900/40 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 shadow-2xl shadow-black/50 overflow-hidden relative group">
                        ...
                        <div className="relative z-10">
                            <h3 className="text-2xl font-light text-white">Plan Pro</h3>
                            <p className="text-sm text-neutral-400 mt-2 max-w-md">
                                Galerías ilimitadas · Múltiples nubes · Perfil público · Dominio personalizado (próximamente)
                            </p>
                        </div>
                        <button className="relative z-10 px-8 py-3 rounded-full border border-neutral-700 hover:border-neutral-500 hover:bg-neutral-800 transition text-sm font-medium">
                            Cambiar plan
                        </button>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                        <div className="p-5 rounded-2xl border border-neutral-800 bg-neutral-900/40">
                            ...
                            <p className="text-white text-xl font-light">12 / <span className="opacity-30">∞</span></p>
                        </div>
                        <div className="p-5 rounded-2xl border border-neutral-800 bg-neutral-900/40">
                            <p className="text-[10px] uppercase font-bold text-neutral-600 mb-1">Nubes conectadas</p>
                            <p className="text-white text-xl font-light">3 / <span className="opacity-30">∞</span></p>
                        </div>
                        <div className="p-5 rounded-2xl border border-neutral-800 bg-neutral-900/40">
                            <p className="text-[10px] uppercase font-bold text-neutral-600 mb-1">Visitas del mes</p>
                            <p className="text-white text-xl font-light">1,284</p>
                        </div>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div className="p-8 rounded-3xl border border-neutral-800 bg-neutral-900/40 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-b-4 border-b-neutral-800">
                        ...
                        <button className="px-8 py-3 rounded-full bg-white text-black hover:bg-neutral-200 transition text-sm font-bold shrink-0">
                    ...
                    <div className="p-8 rounded-3xl border border-red-900/20 bg-red-950/5 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                        <div>
                            ...
                            <p className="text-xs text-neutral-500 max-w-md">
                                Al cancelar, tus galerías existentes seguirán activas pero no podrás crear nuevas ni conectar más nubes. No se eliminarán tus archivos de Google Drive.
                            </p>
                        </div>
                        <button className="px-6 py-2.5 rounded-full border border-red-900/30 text-red-400/60 hover:text-red-400 hover:border-red-500 hover:bg-red-500/5 transition text-xs font-bold shrink-0">
                            Cancelar plan
                        </button>
                    </div>
                </section>
