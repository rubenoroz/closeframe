                    ...
                    <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-20">
                        ...
                        <div>
                            ...
                            <ul className="space-y-4 text-sm font-medium text-white/40">
                                <li><Link className="hover:text-white transition-colors" href="/legal/terminos_y_condiciones_closerlens">Términos de Servicio</Link></li>
                                <li><Link className="hover:text-white transition-colors" href="/legal/politica_de_privacidad_closerlens">Política de Privacidad</Link></li>
                            </ul>
                        </div>
                    </div>
